A simple [Passport](http://passportjs.org/) strategy for LinkedIn OAuth2 that works with lite AND email profile.
Strategy scope is now correctly defined for 'r_emailaddress'.

## Install

  npm install @smpincode/passport-linkedin-oauth2v2
...
[Auth0](https://github.com/auth0) [SMPinCode](https://github.com/SMPinCode)
